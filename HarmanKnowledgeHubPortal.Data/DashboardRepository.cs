    ...
    public class DashboardRepository : IDashboardRepository
    {
        ...
        public async Task<DashboardDto> GetDashboardAsync()
        {
            ...
            return new DashboardDto
            {
                ...
                ReviewedArticles = articles.Count(a => a.Ratings.Any()),
                RatedArticles = articles.Count(a => a.Ratings.Any(r => r.RatingNumber > 0)),
                ...
                TopPublishersThisMonth = articles
                    ...
                    .Select(g => new TopPublisherDto
                    {
                        ...
                        RatingsCount = g.SelectMany(a => a.Ratings).Count()
                    })
